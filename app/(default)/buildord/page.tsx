    ...
    const steps = [
        {
            ...
            listItems: [
                ...
                '<b>Note:</b> If you just want to get ord that runs on ARM64, you can download my pre-built it here. <a href="/data/ord-0.16-arm64.zip" target="_blank" rel="noopener noreferrer" style="color: #3490dc; font-weight: bold;">ord-0.16-arm64.zip</a>',
            ],
        },
